...
export default function SignupPage() {
  ...
  useEffect(() => {
    // Always fetch pricing for Bangladesh
  ...
  async function handleSignup(e: React.FormEvent) {
    ...
    try {
      ...
      setSuccessMessage(
        `Registration successful! Membership fee: ${pricing.currencySymbol}${pricing.membershipFeeAmount} ${pricing.currencyCode}. Please proceed to payment.`
      );
        ...
        <Card className="w-full max-w-2xl shadow-xl">
          <CardHeader className="space-y-1">
            ...
            <CardDescription className="text-center text-base">
              Join MigrateSafely.com - Your trusted migration partner
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                {loadingPricing ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="text-2xl font-bold text-blue-900 dark:text-blue-100">
                      {pricing.currencySymbol}{pricing.membershipFeeAmount} {pricing.currencyCode}
                    </div>
                    <p className="text-xs text-blue-700 dark:text-blue-300">
                      (set by MigrateSafely.com Admin)
                    </p>
                  </div>
                ) : (
                  <p className="text-sm text-red-600 dark:text-red-400">
                    Unable to load membership fee for selected country
                  </p>
                )}
              </div>
